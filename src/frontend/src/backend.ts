...
import type { ExternalBlob as _ExternalBlob, FileData as _FileData, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async cleanupFiles(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cleanupFiles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async compressFile(arg0: FileId): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.compressFile(arg0);
                return from_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async convertFormat(arg0: FileId, arg1: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.convertFormat(arg0, arg1);
                return from_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async downloadFile(arg0: FileId): Promise<FileData> {
        if (this.processError) {
            try {
                const result = await this.actor.downloadFile(arg0);
                return from_candid_FileData_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async resizeImage(arg0: FileId, arg1: bigint, arg2: bigint): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.resizeImage(arg0, arg1, arg2);
                return from_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadFile(arg0: ExternalBlob, arg1: string): Promise<FileId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ExternalBlob_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ExternalBlob): Promise<ExternalBlob> {
    return await _downloadFile(value);
}
async function from_candid_FileData_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileData): Promise<FileData> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        blob: await from_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value.blob),
